...
set(_DDK_ROOT_PATHS PATHS $ENV{DDK_HOME} NO_CMAKE_FIND_ROOT_PATH)
...
function(find_ddk_host_lib _var _names)
    find_library(${_var} NAMES ${_names} NAMES_PER_DIR ${_DDK_HOST_LIB_PATHS} PATH_SUFFIXES ${_DDK_HOST_PATH_SUFFIXES} NO_SYSTEM_ENVIRONMENT_PATH NO_CMAKE_SYSTEM_PATH)
endfunction()

function(find_ddk_device_lib _var _names)
    find_library(${_var} NAMES ${_names} NAMES_PER_DIR ${_DDK_ROOT_PATHS} PATH_SUFFIXES ${_DDK_DEVICE_PATH_SUFFIXES} NO_SYSTEM_ENVIRONMENT_PATH NO_CMAKE_SYSTEM_PATH)
endfunction()
...
if(NOT DDK_FOUND)
    ...
    find_ddk_host_lib(DDK_HIAI_COMMON_LIBRARY hiai_common)
    ...
    find_ddk_host_lib(DDK_HOST_OPENCV_LIBRARY opencv_world)
    ...
    find_ddk_device_lib(DDK_OPENCV_LIBRARY opencv_world)
